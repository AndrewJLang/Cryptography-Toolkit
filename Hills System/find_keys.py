...
# encriptedText = "OTG WRV RHU GXO XUQ UEK VYO TSE NYU NSI YSH MHB BUR ZTR CCD DAK MHC ALI OJZ UOT JYC KFN KIO THO GWK Z"
encriptedText = "YMAWABGYAWKYYUWJSNYMCZ"


#for a=1

encriptedText = encriptedText.replace(" ", "")
# commonWord = "CHEESY" #This must be 5 letters
